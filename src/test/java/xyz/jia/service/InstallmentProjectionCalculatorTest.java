...
public class InstallmentProjectionCalculatorTest {
    ...
    public void testCalculate() {
        ...
        Mockito.when(calculatorUtils.getInstallments(input, principalForEachInstallment, noOfInstallments, false))
                .thenReturn(installments);

        InstallmentProjectionResponse response = installmentProjectionCalculator.calculate(input);
